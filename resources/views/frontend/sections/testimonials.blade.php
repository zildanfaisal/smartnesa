        ...
        <div class="testimonial-container-wrapper style1">
            <div class="container">
                <div class="testimonial-wrapper style1 section-padding fix">
                    <div class="shape1"><img src="{{ asset('images/shape/testimonialShape1_1.png') }}" alt="shape"></div>
                    <div class="shape2"><img src="{{ asset('images/shape/testimonialShape1_2.png') }}" alt="shape"></div>
                    <div class="container">
                        <div class="section-title text-center mxw-685 mx-auto">
                            <div class="subtitle">
                                Testimonial <img src="{{ asset('images/icon/fireIcon.svg') }}" alt="icon">
                            </div>
                            <h2 class="title">Bagaimana Review Mereka?</h2>
                        </div>
                                        ...
                                        <div class="testimonial-card style1">
                                            <div class="testimonial-header">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <p class="text">Mahasiswa FMIPA Unesa</p>
                                                </div>
                                            </div>
                                            <div class="testimonial-body">
                                                <ul class="star-wrapper style1">
                                                    <li><img src="{{ asset('images/icon/fireIcon.svg') }}" alt="icon"> </li>
                                                    <li><img src="{{ asset('images/icon/fireIcon.svg') }}" alt="icon"></li>
                                                    <li><img src="{{ asset('images/icon/fireIcon.svg') }}" alt="icon"></li>
                                                    <li><img src="{{ asset('images/icon/fireIcon.svg') }}" alt="icon"></li>
                                                    <li><img src="{{ asset('images/icon/fireIcon.svg') }}" alt="icon"></li>
                                                </ul>
                                                <p class="desc">Program Smartnesa membantu saya memahami
                                                    materi dari dasar. Penyampaian materinya runtut, jelas, dan setiap
                                                    tahapannya begitu mudah. Cocok banget buat pemula yang ingin
                                                    belajar dengan nyaman.</p>
                                            </div>
                                        ...
                                        <div class="testimonial-card style1">
                                            <div class="testimonial-header">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <p class="text">Mahasiswa FT Unesa</p>
                                                </div>
                                            </div>
                                            <div class="testimonial-body">
                                                <ul class="star-wrapper style1">
                                        ...
                                        <div class="testimonial-card style1">
                                            <div class="testimonial-header">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <p class="text">Mahasiswa FISIP Unesa</p>
                                                </div>
                                            </div>
                                            <div class="testimonial-body">
                                                <ul class="star-wrapper style1">
