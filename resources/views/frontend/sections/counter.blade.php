 <div class="counter-section fix" style="margin-top: 80px;">
                        ...
                        <div class="row gy-5">
                            <div class="col-xl-3 col-md-6 d-flex justify-content-center">
                                <div class="counter-box style1 wow fadeInUp" data-wow-delay=".2s">
                                    <div class="counter">
                                        <span class="counter-number">120</span> <span class="plus">+</span>
                                    </div>
                                    <p class="text">Peserta Terdaftar Program Intensif</p>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6 d-flex justify-content-center">
                                <div class="counter-box style1 wow fadeInUp" data-wow-delay=".4s">
                                    <div class="counter">
                                        <span class="counter-number">3</span> <span class="plus">+</span>
                                    </div>
                                    <p class="text">Mentor menjadi pemateri dalam kelas</p>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6 d-flex justify-content-center">
                                <div class="counter-box style1 wow fadeInUp" data-wow-delay=".6s">
                                    <div class="counter">
                                        <span class="counter-number">9</span> <span class="plus">+</span>
                                    </div>
                                    <p class="text">video dapat diakses oleh peserta</p>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6 d-flex justify-content-center">
                                <div class="counter-box style1 wow fadeInUp" data-wow-delay=".8s">
                                    ...
                                    <p class="text">modul dapat di unduh oleh peserta</p>
                                </div>
                            </div>
                        </div>
                    </div>
